			...
			if (a >= 1 && a <= 7) {
				...
				case 4: {
					...
					if (y != 0) {
						...
						System.out.println("Вы ввели некорректную команду, на \"0\" делить "
								+ "нельзя, пожалуйста повторите попытку.\n");
				...
				case 5: {
					...
					if (y != 0) {
						...
						System.out.println("Вы ввели некорректную команду, на \"0\" делить нельзя, "
